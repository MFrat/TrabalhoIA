...
public class Regras {
    ...
    protected void moverPeca(Posicao posInicial, Posicao posFinal){
        /**
         * Verifico se ambas posições pertencem ao conjunto de posições do tabuleiro.
         */
        ...
        /**
         * Verifico se a posFinal é válida.
         * Ou seja, caso exista alguma jogada com a posFinal.
         */
        Jogada jogada = getJogada(jogadas, posFinal);
        
        /**
         * Se nenhuma jogada possível da peça atual possui essa posição como final,
         * então essa jogada é inválida.
         */
        if(jogada == null){
    ...
    private List<Posicao> filtraJogadas(List<Posicao> posicoes, int time){
        /**
         * Pega até aonde a dama pode jogar.
         * Pode ser em alguma borda do tabuleiro ou alguma peça inimiga ou amiga.
         */
    ...
    /**
     * Retorna todas as peças do jogador atual que possuem captura dentro das jogadas válidas.
     * @return 
     */
