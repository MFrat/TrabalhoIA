...
public class Bot extends Jogador {
    ...
    public int goku_mode(Regras regra) { //UTILITY COM PESO PARA DAMA
        ...
        if(regras.getJogadorAtual() == 1)
            return genkindama + regra.getnPecasJogador1() - regra.getnPecasJogador2();
        else return genkindama + regra.getnPecasJogador2() - regra.getnPecasJogador1();
    }
