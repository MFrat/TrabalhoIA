           ...
           try{
               ...
               switch (dificuldade){
                       ...
                       case 2:
                           ...
                           break;
                       case 3:
                           b1 = new Bot(regras,Bot.Dificuldade.CEM_CONTO_QUE_ALINE_NAO_GANHA,Regras.JOGADOR_UM);
                           break;
               }
           }catch(Exception e){
           ...
           try{
               ...
               switch (dificuldade){
                       ...
                       case 2:
                           ...
                           break;
                       case 3:
                           b2 = new Bot(regras,Bot.Dificuldade.CEM_CONTO_QUE_ALINE_NAO_GANHA,Regras.JOGADOR_DOIS);
                           break;
               }
           }catch(Exception e){
               System.out.println("Entrada inválida!");
